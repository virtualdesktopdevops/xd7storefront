...
- **`[String]` svc_username** _(Required)_: Privileged account used by Puppet for installing the software.
...
- **`[String Array]` deliverycontrollers** _(Required)_: List of Citrix Delivery Controllers of the XenDesktop7 site ['srv-cxdc01.domain.net', 'srv-cxdc012.domain.net']
